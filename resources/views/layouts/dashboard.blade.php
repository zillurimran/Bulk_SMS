            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        <span>
                            <img src="{{ asset('uploads/generalSettings') }}/{{ generalSettings()->logo }}" height="35" style="max-height: 35px" alt="Logo">
                        </span>
                        <h2 class="brand-text">SMS Bulk</h2>
                    </a>
                </li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if (Auth::user()->role == 'admin')
                    ...
                    <li class="nav-item @yield('offers')">
                        <a class="d-flex align-items-center" href="{{ route('offers.index') }}">
                            <i data-feather='settings'></i>
                            <span class="menu-title text-truncate">Offer Settings</span>
                        </a>
                    </li>
