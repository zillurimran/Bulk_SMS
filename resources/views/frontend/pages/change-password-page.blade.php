    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-8 mx-auto">
                ...
                @endif
                    <h1 class="section-header__title section-header__title--lg text-capitalize">Create New Password</h1>
                </div>
                <form action="{{ route('update.password') }}" method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input data-target="password" type="password" name="password_confirm" class="form-control" placeholder="Confirm Password" required>
                            <div class="input-group-append">
                                <button data-toggle="password" type="button" class="btn btn-outline-dark rounded-0 shadow-none">
                                    <i class="bi bi-eye-fill"></i>
                                </button>
